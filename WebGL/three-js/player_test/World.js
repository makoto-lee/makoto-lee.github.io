...
export class World {
    constructor(gravity = 0.01) {
        this.gravity = gravity;
        this.ground_list = [];
    }

    addGround(ground_mesh) {
        this.ground_list.push(new HitBox(ground_mesh));
    }
    ...
    update() {
        ...
        for (let i = 0; i < this.ground_list.length; i++) {
            ...
            if (World._collision_detect(this.player.box, this.ground_list[i])) {
                console.log("collid !!!!");
